...
const Card = ({ id, name, description, imageURL, youtubeURL, xURL, instagramURL, onEdit, onInfo }) => {
            ...
            <div className="card-content">
                <div className="creator-actions-row">
                    ...
                    <div className="creator-actions">
                        <a onClick={onEdit} className="edit-button" title='Edit'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M12 20h9" />
                                <path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19l-4 1 1-4 12.5-12.5z" />
                            </svg>
                        </a>
                        <a onClick={onInfo} className="details-button" title='Details'>
